package com.haivo.hailibrary.util;
...
public class ResHelper {
    ...
    public static Resources getResources() {
        return HaiLib.getHaiApplication().getResources();
    }

    public static String getStringByName(String name) {
        int id =
            getResources().getIdentifier(name, "string", HaiLib.getHaiApplication().getPackageName());
    ...
    public static String getStringByResId(@StringRes int resId) {
        return HaiLib.getHaiApplication().getString(resId);
    }

    public static String getStringByResId(@StringRes int resId, Object... args) {
        return HaiLib.getHaiApplication().getString(resId, args);
    }
